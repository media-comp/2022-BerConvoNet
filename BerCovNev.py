...
df = pd.read_csv('fake_or_real_news.csv.rar')
...
batch_size = 16
train_data = TensorDataset(x_train_tokens['input_ids'], x_train_tokens['token_type_ids'],
                           x_train_tokens['attention_mask'], y_train_tensor)
...
test_data = TensorDataset(x_test_tokens['input_ids'], x_test_tokens['token_type_ids'], x_test_tokens['attention_mask'],
                          y_test_tensor)
